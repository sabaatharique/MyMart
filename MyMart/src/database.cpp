...
bool Database::initialiseDatabase()
{
    ...
    sql = "INSERT OR IGNORE INTO PRODUCTS VALUES(21000, 'APPLES RED', 150, 100, 0, '2025-06-19');"
          ...
          "INSERT OR IGNORE INTO PRODUCTS VALUES(22001, 'MILK', 100, 80, 60, '2025-12-25');"
    ...
    sql = "INSERT OR IGNORE INTO CUSTOMERS VALUES(10000001, 'DIDHITI NAHID', 'REGULAR', 675);"
          ...
          "INSERT OR IGNORE INTO CUSTOMERS VALUES(20000003, 'RAHATUT TAHRIM', 'LOYAL', 12500);"
          "INSERT OR IGNORE INTO CUSTOMERS VALUES(10000004, 'ELON MUSK', 'REGULAR', 9950);";
    if(!executeQuery(sql))
        return false;
